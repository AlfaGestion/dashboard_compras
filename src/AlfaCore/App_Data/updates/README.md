...
- ejecutar cada script una sola vez por base, controlando el avance con `TA_CONFIGURACION.CLAVE = FECHAUPDATE_CORE`
...
- `FECHAUPDATE_CORE` debe guardar la versión textual completa, por ejemplo `2026-05-14-001`
- el prefijo `NNN` permite varias actualizaciones el mismo día
- si una base todavía tiene un `FECHAUPDATE_CORE` viejo en formato solo fecha, el sistema lo interpreta como una versión legada de ese día
